...
3. Добавлены dunder-методы
    ...
    * ''__str__'' - для красивого вывода информации о фигуре
    * ''__repr__''- для технического представления объекта
    * Дополнительный dunder-метод (например, ''__eq__'' для сравнения)
